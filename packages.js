...
(function () {
  ...
  style.textContent =
    ...
    '.pk-head h3{position:relative;z-index:1;margin:0;font-size:1.55rem;color:#fff !important;text-shadow:0 2px 10px rgba(0,0,0,.45)}' +
    '.pk-guests{color:#fff !important;opacity:.95;text-shadow:0 1px 4px rgba(0,0,0,.35)}' +
    '#prices .pack[data-theme="cyber"] .pk-head h3,#prices .pack[data-theme="savanna"] .pk-head h3,#prices .pack[data-theme="berry"] .pk-head h3,#prices .pack[data-theme="jungle"] .pk-head h3{color:#fff !important;text-shadow:0 2px 12px rgba(0,0,0,.5) !important}' +
    '#prices .pack[data-theme="cyber"] .pk-head .pk-guests,#prices .pack[data-theme="savanna"] .pk-head .pk-guests,#prices .pack[data-theme="berry"] .pk-head .pk-guests,#prices .pack[data-theme="jungle"] .pk-head .pk-guests{color:#fff !important}' +
    '.pk-mark{background:#fff !important;color:#111a3b !important;box-shadow:0 6px 16px rgba(0,0,0,.18)}' +
    '.pack[data-theme="cyber"] .pk-mark,.pack[data-theme="savanna"] .pk-mark{background:#ffc72c !important;color:#111a3b !important}' +
    '.pack[data-theme="cyber"] .pk-head{background:linear-gradient(135deg,#0b1230,#2f5fff) !important}' +
    '.pack[data-theme="cyber"] .pk-head h3{letter-spacing:.4px}' +
