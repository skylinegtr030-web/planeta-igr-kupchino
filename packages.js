...
(function () {
  ...
  style.textContent =
    ...
    '.pk-head h3{position:relative;z-index:1;margin:0;font-size:1.55rem;color:#fff;text-shadow:0 2px 8px rgba(0,0,0,.35)}' +
    '.pk-guests{color:#fff;text-shadow:0 1px 4px rgba(0,0,0,.3)}' +
