...
var ORDER_CATALOG = {
  ...
  "extras": {
    "azot": {
      ...
      "c1": "#e2231a",
      "c2": "#ff8a65",
      "desc": "Эффектное шоу с жидким азотом — облака холодного пара, яркие эффекты и восторг у детей и взрослых."
    },
    "neon": {
      "name": "Неоновое шоу",
      "price": 10000,
      ...
      "c1": "#1f5fd6",
      "c2": "#63e6ff",
      "desc": "Световое шоу в неоновых красках с интерактивом для гостей — эффектно смотрится в затемнённой комнате."
    },
    "bubbles": {
      "name": "Мыльные пузыри",
      "price": 10000,
      ...
      "desc": "Шоу гигантских мыльных пузырей — можно забраться внутрь пузыря и сделать эффектные фото."
    },
    "challenge": {
      "name": "Челлендж-пати",
      "price": 8500,
      ...
      "c1": "#ffc72c",
      "c2": "#ffe27a",
      "desc": "Командные конкурсы и весёлые челленджи для всей компании — соревновательный формат праздника."
    },
    "pinata": {
      "name": "Пиньята",
      "price": 4000,
    ...
    "masterclass": {
      ...
      "options": [
        {
          "name": "Слайм-лаборатория",
          "meta": "5+ лет · 30–40 мин"
        },
        {
          "name": "Пушистый Монстрик",
          "meta": "4+ лет · 30–40 мин"
        },
        {
          "name": "Свеча из вощины",
          "meta": "5+ лет · 25–30 мин"
        },
        {
          "name": "Роспись шопера",
          "meta": "6+ лет · 40–60 мин"
        },
        {
          "name": "Магнитик на память",
          "meta": "4+ лет · 25–30 мин"
        }
      ]
    },
    "quest": {
    ...
    "magician": {
      ...
      "c1": "#111a3b",
      "c2": "#1f5fd6",
      "photo": "extra-magician.jpg",
      "desc": "Эффектное шоу фокусника с участием гостей — трюки, магия и восторженные лица детей."
    }
  }
};
...
function doPost(e) {
  ...
  try {
    ...
    if (header.getValue() && header.getValue() !== 'ID заявки') throw new Error('Unexpected column Q');
    if (!header.getValue()) header.setValue('ID заявки');
