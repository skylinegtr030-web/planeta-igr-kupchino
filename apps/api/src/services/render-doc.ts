...
.logo{font-weight:800;text-transform:uppercase;letter-spacing:.02em;text-decoration:none;display:flex;gap:10px;align-items:center}.logo img{width:34px;height:34px;border-radius:50%}
...
<header class="top"><a class="logo" href="/"><img src="/logo.png" alt="" width="34" height="34">Планета Игр</a>
